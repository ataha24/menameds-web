        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <FadeIn>
              <SectionHeader
                eyebrow="Overview"
                title="A community-centered showcase"
                id="expo-overview-heading"
              />
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {exhibitor.website && exhibitor.website !== "#" && (
                        <a
                          ...
                          aria-label={`Visit ${exhibitor.name}`}
                        >
            ...
            <div className="mt-8 bg-amber-50 border border-amber-100 rounded-xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="flex-1">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  We welcome applications from community organizations, research groups, student initiatives, and health services.
                </p>
              </div>
              <Link
                href="/get-involved"
                className="shrink-0 inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-amber-500 text-white font-semibold text-sm hover:bg-amber-400 transition-colors"
              >
                Submit Your Organization
              </Link>
            </div>
