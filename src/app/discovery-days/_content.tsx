// FULL PAGE CONTENT — preserved for when Discovery Days is ready to launch.
    ...
    <div className="pt-16">
                ...
                <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5 flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      {item.tags.map((tag) => (
                        <span key={tag} className="flex items-center gap-1 text-[10px] font-medium text-slate-500 bg-slate-100 rounded-full px-2 py-0.5">
                          <Tag size={9} /> {tag}
                        </span>
                      ))}
                    </div>
            ...
            {[
              {
                ...
                description: "Lead a one-on-one mentoring session with a student during the Mentor Match lunch. Share your path into medicine and answer honest questions.",
                who: "Attending physicians, fellows, residents",
              },
              {
                role: "Student Volunteer",
                description: "Help facilitate workshops, support registration, guide students through the day, and share your experience as a current medical student.",
                who: "Stanford medical students (all years)",
              },
              {
                role: "Organizational Partner",
                description: "Bring your organization's work to Discovery Days as a resource table or co-presenter. Great for community organizations, clinics, and advocacy groups.",
              ...
              <FadeIn key={item.role} delay={i * 0.1}>
                <div className="bg-slate-50 rounded-xl border border-slate-100 p-6 h-full">
                  <p className="text-xs font-semibold uppercase tracking-widest text-cardinal-600 mb-2">{item.role}</p>
      ...
      <section className="py-16 bg-slate-50" aria-labelledby="faq-dd-heading">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <SectionHeader eyebrow="FAQ" title="Common questions" id="faq-dd-heading" center />
          </FadeIn>
          <FadeIn delay={0.1}>
            <div className="mt-8">
